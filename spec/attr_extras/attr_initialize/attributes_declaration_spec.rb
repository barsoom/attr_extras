...
describe AttrExtras::AttrInitialize::AttributesDeclaration do
  ...
  it "handles just positional arguments" do
    ...
    attributes = AttrExtras::AttrInitialize::AttributesDeclaration.new(no_hash_argument)
  ...
  it "handles just hash arguments" do
    ...
    attributes = AttrExtras::AttrInitialize::AttributesDeclaration.new(just_hash_arguments)
  ...
  it "handles just hash arguments with default values" do
    ...
    attributes = AttrExtras::AttrInitialize::AttributesDeclaration.new(just_hash_arguments_with_default_values)
